...
// declare empty List of Post
List<PostList> list = [];
// future function to call http.get method for RestApi("https://jsonplaceholder.typicode.com/posts")
...
// default constructor with requires parameters
  PostList(
      {required this.id,
...
// factory method helps to create instance of same class
